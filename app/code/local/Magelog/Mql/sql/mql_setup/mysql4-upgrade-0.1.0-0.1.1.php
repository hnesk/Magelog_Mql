...
// this is only a cache table, lets recreate it
$installer->run("
...
CREATE TABLE {$installer->getTable('mql_model')} (
  ...
  `is_db_collection`   TINYINT(1)      NOT NULL DEFAULT '0',
  `is_instantiable`    TINYINT(1)      NOT NULL DEFAULT '0',
  `is_get_model_instantiable`      TINYINT(1)      NOT NULL DEFAULT '0',
